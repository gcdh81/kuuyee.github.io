...
暂时没有找到解决办法。找了个替代方案，先上传到本地，让本机可以先构建，命令如下：
    ...
    mvn com.oracle.maven:oracle-maven-sync:12.1.3-0-0:push -Doracle-maven-sync.oracleHome=/opt/oracle/middleware12c 
    -Dmaven.repo.local=/ciroot/archiva/repositories/internal
